      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-lg shadow-slate-500 rounded-xl bg-zinc-700 hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src='/../public/assets/skills/postgres.png' width='64px' height='64px' alt='/' />
              </div>
          ...
          <div className='p-6 shadow-lg shadow-slate-500 rounded-xl bg-zinc-700 hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src='/../public/assets/skills/sequelize.png' width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Sequelize</h3>
              </div>
          ...
          <div className='p-6 shadow-lg shadow-slate-500 rounded-xl bg-zinc-700 hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src='/../public/assets/skills/typescript.png' width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Typescript</h3>
              </div>
